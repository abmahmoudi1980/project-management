    ...
    <form class="mt-6 sm:mt-8 space-y-6" onsubmit={(e) => { e.preventDefault(); handleSubmit(); }}>
      ...
      <div>
        ...
        <input
          ...
          required
          class="mt-1 appearance-none rounded-md relative block w-full px-3 py-3 min-h-[44px] border border-slate-300 placeholder-slate-500 text-slate-900 focus:outline-none focus:ring-brand-500 focus:border-brand-500 sm:text-sm"
