...
<div class="max-w-md mx-auto mt-4 sm:mt-8 p-4 sm:p-6 bg-white rounded-lg shadow-md" dir="rtl">
  <h2 class="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-center text-slate-800">ثبت‌نام</h2>
  ...
  <form onsubmit={(e) => { e.preventDefault(); handleSubmit(); }}>
    ...
    <div class="mb-6">
      <label for="passwordConfirmation" class="block text-sm font-medium text-slate-700 mb-2">
        تکرار رمز عبور
      </label>
      <input
        type="password"
