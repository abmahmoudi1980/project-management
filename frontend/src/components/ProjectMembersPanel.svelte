...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6" dir="rtl">
  <h2 class="text-xl font-bold text-gray-900 mb-4">اعضای پروژه</h2>
  ...
  <div class="space-y-2">
    ...
    {:else if members.length === 0}
      <p class="text-gray-500 text-center py-8">هنوز عضوی به این پروژه اضافه نشده است.</p>
    {:else}
